  ...
  <template>
    <ion-page>
      <ion-header>
        <ion-toolbar>
          <ion-buttons >
              <ionlabel>Latest Health News</ionlabel>
    ...
    <script>
    import { IonCard, IonCardContent, IonCardSubtitle, IonCardTitle ,IonImg ,IonPage ,LoadingController ,
AlertController } from '@ionic/vue';
    ...
    export default defineComponent({
      ...
      setup() {
        ...
        axios
          .get("https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=31a7736e56d844cea156f84b6a5b2705")
          .then((response) => 
